...
## Acknowledgements
- The Movie Website Project utilizes Laravel, a PHP framework, for building web applications `laravel.com`.`php.net`.
- Bootstrap is used for the frontend design and layout [getboostrap.com].
